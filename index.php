            ...
            <div class="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div class="card" >
                    ...
                    <div class="card-body" >
                        ...
                        <h5 class="d-inline"><div class="text-muted d-inline">($<?= $product->price; ?>/item)</div></h5>
                        <p><?= substr($product->description, 0, 40) ;?> </p>
                         <a href="<?= APPURL ?>shopping/single.php?id=<?= $product->id; ?>"  class="btn btn-primary w-100 rounded my-2"> More<i class="fas fa-arrow-right"></i> </a>      
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
